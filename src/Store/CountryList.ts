const CountryList = [
    ...
    { id: 27, code: "BO", name: "Bolivia (Plurinational State of)" },
    ...
    { id: 55, code: "CI", name: "Côte d'Ivoire" },
    { id: 56, code: "HR", name: "Croatia" },
    { id: 57, code: "CU", name: "Cuba" },
    { id: 58, code: "CW", name: "Curaçao" },
    ...
    { id: 132, code: "MK", name: "Macedonia (the former Yugoslav Republic of)" },
    ...
    { id: 145, code: "FM", name: "Micronesia (Federated States of)" },
    { id: 146, code: "MD", name: "Moldova (Republic of)" },
    ...
    { id: 170, code: "PS", name: "Palestine, State of" },
    ...
    { id: 214, code: "SZ", name: "Eswatini" },
    { id: 215, code: "SE", name: "Sweden" },
    { id: 216, code: "CH", name: "Switzerland" },
    { id: 217, code: "SY", name: "Syrian Arab Republic" },
    ...
    { id: 235, code: "GB", name: "United Kingdom of Great Britain and Northern Ireland" },
    { id: 236, code: "US", name: "United States of America" },
    ...
    { id: 241, code: "VE", name: "Venezuela (Bolivarian Republic of)" },
    { id: 242, code: "VN", name: "Viet Nam" },
    { id: 243, code: "VG", name: "Virgin Islands (British)" },
    { id: 244, code: "VI", name: "Virgin Islands (U.S.)" },
  ];
